...
MOVIE_SYSTEM = (
    ...
    "- After an add, if `alts` lists a better-known film of the same title, name it and ask "
    "if THAT's the one they meant — offer to swap (remove this, add that) or keep it. A "
    "gentle check, never a refusal. Never mention no_letterboxd_rating or the absence of a "
    "rating in your confirmation — just confirm the save.\n"
